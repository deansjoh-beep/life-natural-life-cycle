              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm md:col-span-2 no-print">
                  ...
                  <p className="mt-3 text-[11px] text-gray-400 flex items-center gap-1">
                    <Info size={12} /> 조후(월지·시지의 냉온)상 조후용신에 해당하는 글자가 지지에 있는 간지가 입추(정점)이므로, 그 반대편 간지를 입춘 기점으로 선택하세요. 조후가 중립적이면 억부용신에 가까운 글자로 입추를 정합니다.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 gap-6">
                  {[
                    ...
                    },
                    {
                      ...
                      desc: "두 후보 중 어느 간지가 입추(정점)가 될지는 조후로 결정합니다. 먼저 월지와 시지 글자의 냉온 여부로 사주의 한난(寒暖)을 판단합니다. 두 후보 간지 중 지지가 조후용신에 해당하는 글자인 간지가 입추가 되고, 나머지 간지가 입춘이 됩니다. 조후가 중립적인 경우에는 억부용신에 가까운 글자가 지지에 있는 간지를 입추로 정합니다.",
