                ...
                <div className="grid grid-cols-1 gap-6">
                  {[
                    ...
                    },
                    {
                      ...
                      example: "예시: '미(未)'와 반대되는 글자는 '축(丑)'이므로 두 번째 간지는 '정축(丁丑)'이 됩니다. 조정된 경우라면 '계묘'의 반대는 '계유'가 됩니다."
                    },
                    {
                      num: 3,
                    ...
                    },
                    {
                      ...
                      desc: "두 후보 중 어느 간지가 입추(정점)가 될지는 조후로 결정합니다. 먼저 월지와 시지 글자의 냉온 여부로 사주의 한난(寒暖)을 판단합니다(가중치는 월지 2, 시지 1로 월지의 영향이 더 큽니다). 시주(출생 시각)를 모르는 경우에는 월지만으로 조후를 판단합니다. 두 후보 간지 중 지지가 조후용신에 해당하는 글자인 간지가 입추가 되고, 나머지 간지가 입춘이 됩니다. 조후가 중립적인 경우에는 억부용신에 가까운 글자가 지지에 있는 간지를 입추로 정합니다. 지지의 냉온 분류는 한(寒)=해·자·축·인·술, 난(暖)=사·오·미, 중립=묘·진·신·유를 따릅니다. 억부는 자평명리학의 월지 득령 여부를 중심으로 판정합니다 — 월지가 일간의 인성·비겁이면 신강, 아니면 신약으로 보고, 신약이면 일간을 돕는 오행(인성·비겁), 신강이면 힘을 빼거나 억제하는 오행(식상·재성·관성)에 해당하는 지지가 있는 간지를 입추로 정합니다.",
